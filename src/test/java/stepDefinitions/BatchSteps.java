...
//    @PostNewBatch
	...
	public void admin_receives_created_status_for_post_new_batch_with_status_code_and_response_message(
...
//      @PostNewBatch-(Positive9)
	...
	public void admin_receives_created_status_for_post2_new_batch_with_status_code_and_response_message(Integer int1,
			String string) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, string);
	...
	public void admin_receives_updated_status_for_put_with_status_code_and_response_message(Integer int1,
			String string) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
...
//    @Put(UpdateBatchByBatchID)-(Positive11)
	...
	public void admin_receives_updated_status_for_put2_with_status_code_and_response_message(Integer int1,
			String string) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, "OK");
...
//    @GetBatchByProgramID-(Negative10)
	...
	public void admin_receives_not_found_status_with_message_and_boolean_success_details_for_get_batch_by_program_id(
			Integer int1) {
		restUtil.validateStatusCode(response, int1);
	}
...
//    @PostNewBatch-(Negative14)
	...
	public void admin_receives_bad_request_status_with_message_and_boolean_success_details_negative14(Integer int1,
			String string) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, string);
...
//    @PostNewBatch-(Negative16)
	...
	public void admin_receives_bad_request_status_with_message_and_boolean_success_details_negative16(Integer int1,
			String string) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, string);
...
//    @PostNewBatch-(Negative17)
	...
	public void admin_receives_bad_request_status_with_message_and_boolean_success_details_negative17(Integer int1,
			String string) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, string);
...
//    @Put(UpdateBatchByBatchID)-(Negative19)
	...
	public void admin_receives_not_found_status_with_message_and_boolean_success_details_for_update_batch_by_batch_id(
			Integer int1) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, "OK");
...
//    @Put(UpdateBatchByBatchID)-(Negative20)
	...
	public void admin_receives_bad_request_status_with_message_and_boolean_success_details_for_update_batch_by_batch_id(
			Integer int1) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, "OK");
...
//    @Put(UpdateBatchByBatchID)-(Negative21)
	...
	public void admin_receives_bad_request_status_with_message_and_boolean_success_details_for_update_batch_by_batch_id1(
			Integer int1) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, "OK");
...
//    @Put(UpdateBatchByBatchID)-(Negative23)
	...
	public void admin_receives_bad_request_status_with_message_and_boolean_success_details_for_update_batch_by_batch_id2(
			Integer int1) {
		restUtil.extractRes(response);
		restUtil.validateStatusCode(response, int1);
		restUtil.validateStatusMessage(response, "OK");
